...
export class ServiceDataPage {
  ...
  protected selectResource(key: string): void {
    ...
    this.router.navigate(['/service-data', key]);
  }
  ...
  private loadPage(): void {
    ...
    // which would read as "no data" rather than "nothing asked yet".
    if (!resourceKey || !descriptor || !this.tenantIdStore.hasTenantId()) {
      this.page.set(null);
      return;
    }
